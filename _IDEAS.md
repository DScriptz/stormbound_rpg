...
-   [x] **Lore continuation**: Continue writing the main lore for ``Chapter4`` going to ``Open_World``
...
-   [x] Write an immersive background on the Dystopian world Stormbound has.
